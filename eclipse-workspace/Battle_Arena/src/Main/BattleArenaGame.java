...
public class BattleArenaGame {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            System.out.print("Enter your character max-health: ");
            double max_health = sc.nextDouble();
            System.out.print("Enter your character attack power: ");
            double attack_power = sc.nextDouble();
            ...
            Character character = new Character(cname, max_health, attack_power, defense_power, weapon);
            Player player = new Player(playerNames[i], character, weapon);
            players.add(player);
        }
        ...
        switch(choice) {
        case 1:
        	while(players.get(0).getCharacter().getHealth()<=0 || players.get(0).getCharacter().getHealth()<=0) {

                System.out.println(players.get(0).getName()+" have attacked to "+players.get(1).getName()+" attacked by "+players.get(0).getCharacter().getName()+" with "+players.get(0).getWeapon().getWeaponname());
        ...
        case 2:
        	while(players.get(0).getCharacter().getHealth()<=0 || players.get(0).getCharacter().getHealth()<=0) {
                ...
                System.out.println(players.get(1).getName()+" have attacked to "+players.get(0).getName()+" attacked by "+players.get(1).getCharacter().getName()+" with "+players.get(1).getWeapon().getWeaponname());
